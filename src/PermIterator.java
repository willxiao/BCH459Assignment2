...
// Based on algorithm https://en.wikipedia.org/wiki/Steinhaus%E2%80%93Johnson%E2%80%93Trotter_algorithm#Even.27s_speedup
//Code from: http://stackoverflow.com/questions/2000048/stepping-through-all-permutations-one-swap-at-a-time/11916946#11916946
//NOT ORIGINAL CODE
    ...
    implements Iterator<int[]>
{
    ...
    public static void main(String argv[]) {;
        for(Iterator<int[]> it = new PermIterator(10); it.hasNext(); ) {
            int[] a = it.next();
            print(a);
        }
    }
